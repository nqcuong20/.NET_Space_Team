...
using NET_Tedu.Data.EF.Configurations;
...
namespace NET_Tedu.DataEF
{
    public class AppDbContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        public override int SaveChanges()
        {
            ...
            var modifed = ChangeTracker.Entries().Where(e => e.State == EntityState.Modified || e.State ==  EntityState.Added);
            foreach(EntityEntry item in modifed)
            {
                ...
                if(changeOrAddedItem != null)
                {
                    ...
                    {
                        changeOrAddedItem.DateCreate = DateTime.Now;
                    }
